...
export class AudioRecorder {
  ...
  async startRecording() {
    try {
      ...
      console.log('[AUDIO] Audio recording started:', selectedMimeType);
      return true;
    } catch (error) {
  ...
  async stopRecording() {
    return new Promise((resolve, reject) => {
      ...
      this.mediaRecorder.addEventListener('stop', () => {
        ...
        this.isRecording = false;
        console.log('[AUDIO] Audio recording stopped. Size:', (audioBlob.size / 1024 / 1024).toFixed(2), 'MB');
...
export class SpeechRecognizer {
  ...
  start() {
    ...
    try {
      ...
      console.log('[VOICE] Speech recognition started:', this.language);
    } catch (error) {
